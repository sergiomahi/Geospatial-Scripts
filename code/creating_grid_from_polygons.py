...
for i in range(start_file_number,number_of_file):
    ...
    #print(tmp.columns)
    intersects_grid_all.iloc[number_small_grid * i :number_small_grid * (i + 1)][['poly_id', 'geometry']].to_csv(f'{FOLDER_PATH}/{FOLDER_NAME}/{FILE_PREFIX}{i + 1}.csv')
end = time.time()
print(f'Total time: ', end - start)
